...
import com.mr.dao.DiaryDao;
import com.mr.model.Commnet;
import com.mr.model.Diary;
import com.mr.tools.MyPagination;
...
public class DiaryServlet extends HttpServlet {
	...
	private void listComment(HttpServletRequest request,
		...
		List<Commnet> list = dao.getComments(Integer.parseInt(diaryID));
		StringBuilder comments = new StringBuilder();
		comments.append(commentDivID + "<分隔符>");
		for (int i = 0; i < list.size(); i++) {
			Commnet c = list.get(i);
