...
function checkUser(str){
	if(str==""){			//当用户名为空时
		...
		var loader=new net.AjaxRequest("UserServlet?action=checkUser&username="+encodeURI(encodeURI(str))+"&nocache="+new Date().getTime(),deal,onerror,"GET");
	}	
}
function deal(){
...
function getCity(selProvince){
	var loader=new net.AjaxRequest("UserServlet?action=getCity&parProvince="+encodeURI(encodeURI(selProvince))+"&nocache="+new Date().getTime(),deal_getCity,onerror,"GET");
}
    ...
    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FEFEFC">
      <tr>
        <td height="408" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="50" style="color:#1B7F5D;font-size: 14px;"><b>九宫格记忆网--用户注册</b></td>
          </tr>
        </table>
